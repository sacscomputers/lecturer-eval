...
export default function Index({ evaluations, semesters, academicYears, metrics, lecturers }) {
            ...
            datasets: [
                {
                    ...
                    data: lecturers.map((lecturer) => {
                        ...
                        const lecturerEvals = filtered.filter(e => e.lecturer_id === lecturer.id);
                        const total = lecturerEvals.reduce((sum, e) => sum + e.rating, 0);
                        return lecturerEvals.length ? total / lecturerEvals.length : 0;
                    }),
    ...
    }, [selectedSemester, selectedAcademicYear, selectedMetric, selectedLecturer, evaluations, lecturers]);
